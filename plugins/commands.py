...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('Support ', url='https://t.me/PiratesDeveloper')
                ],[
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/PiratesDeveloper")
                         ]
                        ]
                    )
                )
    ...
    if not files_:
        try:
            ...
            if file_id == 'hehe':
                owner = client.get_chat(ADMINS[0])
                btn = [[InlineKeyboardButton("❆ Owner ❆", url=f"{owner.username}.t.me?text=Authorize_Me")]]
                await message.reply_text(
                    chat_id=message.from_user.id,
