class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
Mʏ Nᴀᴍᴇ Is <a href=https://t.me/{}>{}</a>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs, Jᴜsᴛ ASK Movie In @FilmPiratesGroup 😍</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>✯ Mʏ Nᴀᴍᴇ: {}
✯ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/PiratesDeveloper'>Jarvis</a>
...
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="https://t.me/PiratesDeveloper">Jarvis</a></b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/FilmPirateOfficial)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ using /imdb ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ 😃

ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ 👇

ᴇxᴀᴍᴘʟᴇ : Uncharted or Uncharted 2022 or Uncharted 2022 En
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ or Use /request..."""

    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ\n\n<b>Please /request the movie...<b/>"""
...
• ꜰᴜʟʟ ɴᴀᴍᴇ : Jarvis
• ᴜꜱᴇʀɴᴀᴍᴇ : @PiratesDeveloper
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/PiratesDeveloper'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
Search in ɢᴏᴏɢʟᴇ OR use /imdb to get correct spelling
...
=========== • ✠ • ===========
▫️ ᴄʜᴀɴɴᴇʟ : @FilmPirateOfficial
▫️ sᴜᴘᴘᴏʀᴛ : @PiratesDeveloperBot
=========== • ✠ • ===========</b>"""
